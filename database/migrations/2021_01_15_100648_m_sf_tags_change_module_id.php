...
class MSfTagsChangeModuleId extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  public function up()
  {
    Schema::table('m_sf_tags', function (Blueprint $table) {
      $table->renameColumn('module_id', 'user_module_id')->change();

      $table->dropForeign('m_sf_tags_module_id_foreign');
  ...
  public function down()
  {
    Schema::table('m_sf_tags', function (Blueprint $table) {
      ...
      $table->dropForeign('m_sf_tags_user_module_id_foreign');
